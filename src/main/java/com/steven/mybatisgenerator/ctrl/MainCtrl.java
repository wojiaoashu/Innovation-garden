...
public class MainCtrl {
    ...
    public Response pageCountByKey(ServletRequest request) {
        ...
        try {
            ...
            if(pageKey.equals("所有")){
                // 不过滤
                c = articleMapper.selectCount();
            }else if(pageKey.equals("一级创新") || pageKey.equals("二级创新") ||pageKey.equals("三级创新") ||pageKey.equals("未评级") ){
                c = articleMapper.pageCountByLevel(pageKey);
            }else if( pageKey.equals("客服部") || pageKey.equals("私有云") ||pageKey.equals("公有云") ||pageKey.equals("UED") ||pageKey.equals("防火墙") ||pageKey.equals("IOS") ||pageKey.equals("测试中心") ){
                c = articleMapper.pageCountByDepartment(pageKey);
            }else{
                c = articleMapper.pageCountByKey(pageKey);
            }
    ...
    @RequestMapping(value = "/pageCountByInputKey", method = RequestMethod.GET)
    public Response pageCountByInputKey(ServletRequest request) {
        ...
        try {
            ...
            if(pageKey.equals("所有")){
                ...
                c = articleMapper.pageCountByTitleOrContextOrLevel(pageKey);
            }
    ...
    public Response get_OnePageArticlesByKey(ServletRequest request) {
        ...
        try {
            ...
            }else if( pkey.equals("客服部") || pkey.equals("私有云") ||pkey.equals("公有云") ||pkey.equals("UED") ||pkey.equals("防火墙") ||pkey.equals("IOS") ||pkey.equals("测试中心") ){

                listAritcle = articleSelectMapper.selectOnePageWithPreByDepartment(recordStart,pkey);
            }else{
    ...
    // http://127.0.0.1/main/get_OnePageArticlesByInputKey?pageKey='what'&&pageIndex=1
    @RequestMapping(value = "/get_OnePageArticlesByInputKey", method = RequestMethod.GET)
    public Response get_OnePageArticlesByInputKey(ServletRequest request) {
        ...
        try {
            ...
            if(pkey.equals("所有")){
                ...
                listAritcle = articleSelectMapper.selectOnePageWithPreAndInputKey(recordStart,pkey);
            }
